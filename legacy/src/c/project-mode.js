    ...
    view: function(ctrl, args) {
        const project = args.project(),
            ...
            buildTooltip = el => m.component(tooltip, {
                el,
                text: (mode === 'aon') ? `You will only receive resources if you reach or exceed the goal until the ${h.momentify(project.zone_expires_at, 'DD/MM/YYYY')}.` : 'The director will receive all the resources when he closes the campaign, even if he has not reached this goal.',
                width: 280
            });
