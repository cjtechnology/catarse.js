                        ...
                        m('.w-row', [
                            ...
                            m('.w-col.w-col-6', [
                                m('.u-marginbottom-30.fontsize-base', [
                                    m('div', [m('span.fontweight-semibold', `${window.I18n.t('activerecord.attributes.project_post.title')}: `), project.name]),
                                    m('div', [m('span.fontweight-semibold', 'Link: '), `www.catarse.me/${project.permalink}`]),
                                    m('div', [m('span.fontweight-semibold', 'Method of financing: '), window.I18n.t(project.mode, I18nScope())]),
                                    (project.mode !== 'sub' ?
                                        m('div', [m('span.fontweight-semibold', 'Goal of collection: '), `R$ ${h.formatNumber(project.goal, 2, 3)}`]) :
                                        ''),
                                    (project.online_days !== null) ? m('div', [m('span.fontweight-semibold', `Term: ${project.online_days} ${(project.online_days > 1) ? 'days' : 'day'}`)]) : '',
                        ...
                        m('.u-text-center', [
                            m('.w-row', [
                                ...
                                m('.w-col.w-col-10', [
                                    ...
                                    m('.fontsize-small.fontcolor-secondary', "The above data can not be changed after the project goes live. If you need to make changes, navigate to the sidebar and come back here when you're done!")
                                ]),
                                m('.w-col.w-col-1')
                            ])
                        ])
                    ...
                    m('.card.medium.u-radius.u-marginbottom-60', [
                        m('.u-text-center.u-marginbottom-60', [
                            ...
                            m('.w-row', [
                                m('.w-col.w-col-2'),
                                m('.w-col.w-col-8', [
                                    m('.fontsize-small', ["Before posting, click on the circles below and confirm that you are aware of how Catarse works. Any doubt, ", m('a.alt-link[href="/requests/new"][target="_blank"]', 'contact'), '!'])
                                ]),
                                m('.w-col.w-col-2')
                            ])
                        ]),
